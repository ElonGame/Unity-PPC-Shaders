Shader "Custom/Rickter/PPC/AlphaPremultiplied"
{
	Properties
	{
...
// forward pass
		...
		#pragma surface surf StandardCustom addshadow fullforwardshadows exclude_path:deferred alpha:premul
		...
		void surf( Input i , inout SurfaceOutputStandardCustom o )
		{
			...
			o.Albedo = tex2D(_MainTex, _MainTex_UV) * _MainTexColor;
			o.Alpha  = _MainTexColor.a * tex2D(_MainTex, _MainTex_UV).a;
	...
	Fallback "Standard"
	CustomEditor "PPCShaderGUI_AlphaPremultiplied"
}