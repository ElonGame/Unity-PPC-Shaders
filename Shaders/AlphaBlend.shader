Shader "Custom/Rickter/PPC/AlphaBlend"
{
	Properties
	{
...
// forward pass
		...
		#pragma surface surf StandardCustom addshadow fullforwardshadows exclude_path:deferred alpha:blend
	...
	Fallback "Standard"
	CustomEditor "PPCShaderGUI_AlphaBlend"
}