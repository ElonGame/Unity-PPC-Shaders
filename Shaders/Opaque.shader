Shader "Custom/Rickter/PPC/Opaque"
{
	Properties
	{
		...
		_MainTexColor("Albedo Color", Color) = (1,1,1,1)
...
// forward pass
		...
		#pragma surface surf StandardCustom addshadow fullforwardshadows exclude_path:deferred
		...
		void surf( Input i , inout SurfaceOutputStandardCustom o )
		{
			...
			o.Albedo = tex2D(_MainTex, _MainTex_UV).rgb * _MainTexColor.rgb;
	...
	Fallback "Standard"
	CustomEditor "PPCShaderGUI_Opaque"
}